...
import top.ctnstudios.blocks.StoneCraftingTable;
...
public class Blocks {
    ...
    public static final Block DEEPSLATE_STONE_ESSENCE_ORE  = new Block(FabricBlockSettings
        ...
        .requiresTool()
        .strength(4.5f,3.0f));
    public static final Block STONE_CONVERSION_TABLE  = new Block(FabricBlockSettings
        .create()
        .mapColor(MapColor.STONE_GRAY)
        .instrument(Instrument.BASEDRUM)
        .sounds(BlockSoundGroup.STONE)
        .requiresTool()
        .strength(2.0f,6.0f));
    public static final StoneCraftingTable STONE_CRAFTING_TABLE  = new StoneCraftingTable(FabricBlockSettings
        .create()
        .mapColor(MapColor.STONE_GRAY)
        .instrument(Instrument.BASEDRUM)
        .sounds(BlockSoundGroup.STONE)
