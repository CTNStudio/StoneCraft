...
public class StoneElderModel extends EntityModel<StoneElderEntity> {
    ...
    private final ModelPart mz_r1;
    private final ModelPart mz1;
    private final ModelPart cube_r1;
    private final ModelPart stzx;
    ...
    private final ModelPart mz2;
    private final ModelPart cube_r10;
    private final ModelPart zss;
    private final ModelPart zsx;
    private final ModelPart yss;
    private final ModelPart ysx;
    private final ModelPart fz;
    ...
    @Override
    public void setAngles(StoneElderEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
    @Override
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
        stone_elder.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
    }
}